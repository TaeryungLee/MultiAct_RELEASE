...
from utils.smplx.body_model.lbs import lbs
import sys
...
class BodyModel(nn.Module):
    ...
    def __init__(self,
        ...
        if '.npz' in bm_fname:
            ...
            with open(bm_fname, 'rb') as smplh_file:
                smpl_dict = pickle.load(smplh_file, encoding='latin1')
            
            smpl_dict['J_regressor'] = smpl_dict['J_regressor'].toarray()
            smpl_dict['shapedirs'] = np.array(smpl_dict['shapedirs'])
        else:
